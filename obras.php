...
<header id="header" class="header d-flex align-items-center sticky-top">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      // Referência ao botão de scroll
      const scrollTopButton = document.getElementById('scroll-top');
      
      // Quando o modal do PDF for aberto
      document.getElementById('pdfModal').addEventListener('show.bs.modal', function () {
        scrollTopButton.style.transition = 'opacity 0.3s ease, transform 0.3s ease';
      ...
      // Quando o modal do PDF for fechado
